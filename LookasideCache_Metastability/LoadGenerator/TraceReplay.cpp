...
using namespace std;
string ngnix_server_ip = "172.31.14.78";
...
int main(int argc, char** argv)
{
    ...
    /* 
        le:  Loadshedding enabled       l
        dst: Drop Session Start Time Offset    d   (relative to TraceReplay start time)
        tdp: Total Drop Period          e
        dwl: Drop Window Length         f
        dp:  Drop Probability           g
        tlp: Total Loadshedding period (dictates how windows will be spread ) h
    */
    int opt = 0;
    string filename;
    do {
    ...
    // Loadshedding related calculations
    cout<<"Experiment: IsOpen = " << openLoop << endl;
